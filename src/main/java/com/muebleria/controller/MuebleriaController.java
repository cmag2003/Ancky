...
public class MuebleriaController {
	// llamar al repository -> usando objetos
		...
		public String abrirpagMantenedorProductos(Model model) {
		...
		public String abrirpagConsultaProductos(Model model) {
		...
		//controlador para grabar un proveedor 
			...
			public String buscarProducto(@RequestParam("descripcion") String descripcion, Model model) {
